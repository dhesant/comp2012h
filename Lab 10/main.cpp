...
int main ()
{
    int arr1size = 5;
    int arr1[] = {1, 2, 3, 4, 5};
    Array array1(arr1, arr1size);     // constructor with an array
    int i;
    ...
    Array array2;     // default constructor
    ...
    Array array4;     // default constructor
    array4 = array1;        // assignment operator
    cout << "array1 == array4 is " << (array1 == array4) << endl;

    Array array5(arr1size);   // constructor with intial size
